    ...
    internal static class RateLimitsDefinitions
    {
        internal static Dictionary<RateLimitType, RateLimits> RateLimitsTime()
        {
            ...
            return new Dictionary<RateLimitType, RateLimits>()
            {
              ...
              { RateLimitType.FulFillmentInbound_GetListInboundPlans,               new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_CreateInboundPlan,                 new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_GetInboundPlan,                    new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_ListInboundPlanBoxes,              new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_CancelInboundPlan,                 new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ListInboundPlanItems,              new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_SetPackingInformation,             new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ListPackingOptions,                new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GeneratePackingOptions,            new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ConfirmPackingOption,              new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ListPackingGroupItems,             new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_ListInboundPlanPallets,            new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_ListPlacementOptions,              new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GeneratePlacementOptions,          new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ConfirmPlacementOption,            new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_GetShipment,                       new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GetDeliveryChallanDocument,        new RateLimits(1.0M, 1) },             
              { RateLimitType.FulFillmentInbound_UpdateShipmentDeliveryWindow,      new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GetSelfShipAppointmentSlots,       new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GenerateSelfShipAppointmentSlots,  new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_CancelSelfShipAppointment,         new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_ScheduleSelfShipAppointment,       new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_UpdateShipmentTrackingDetails,     new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_ListTransportationOptions,         new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GenerateTransportationOptions,     new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ConfirmTransportationOptions,      new RateLimits(0.05M, 1) },
              { RateLimitType.FulFillmentInbound_ListItemComplianceDetails,         new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_UpdateItemComplianceDetails,       new RateLimits(1.0M, 1) },
              { RateLimitType.FulFillmentInbound_GetInboundOperationStatus,         new RateLimits(1.0M, 1) },
